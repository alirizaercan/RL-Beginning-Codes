...
DATASET_PATH = Path("fine-tune/dataset_samples/lunarlander_dataset.json")
DEFAULT_OUTPUT_PATH = Path("fine-tune/reports/lunarlander_dataset_dashboard.html")
...
<body>
  <div class="container">
    <section class="hero">
      <div class="hero-card">
        <div class="eyebrow">LunarLander Veri Seti Incelemesi</div>
        <h1>Action Dagilimi ve State Kapsami Dashboard'u</h1>
        <p>
          Bu ekran, fine-tuning veri setinin LunarLander state'lerini dort ayrik action arasinda nasil dagittigini ozetler.
...
def main() -> None:
    ...
    print(f"{len(df):,} ornek yuklendi: {DATASET_PATH}")
